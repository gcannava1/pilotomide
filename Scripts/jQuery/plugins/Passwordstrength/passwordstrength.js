...
digitalspaghetti.password = {
    ...
    'attachWidget': function (element) {
        var output = ['<div id="password-strength" style="float:right;">'];
        ...
        output.push('<span class="password-strength-bar" style="width:230px;font-size: 11px;"></span>');
        output.push('</div>');
        output = output.join('');
    ...
    'calculateScore': function (word) {
        ...
        jQuery('.password-strength-bar').css({ 'display': 'none' });
        ...
        if (word != '') {
            ...
            jQuery('.password-strength-bar').css({ 'display': 'block' });
            jQuery('.password-strength-bar').html('Nivel de seguridad de contrase&ntilde;a<br><div style="display: inline-block; background-color:' + digitalspaghetti.password.strColor + ';width: 20px">&nbsp;</div> <b>' + digitalspaghetti.password.strText + '</b>')
        }
