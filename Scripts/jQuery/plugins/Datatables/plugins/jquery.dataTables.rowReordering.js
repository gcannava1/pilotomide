...
(function ($) {
    ...
    $.fn.rowReordering = function (options) {
        ...
        function fnGetState(oTable, sSelector, id) {
            ...
            if (id == '') return { sDirection: '', iCurrentPosition: -1, iNewPosition: -1 }; // SORTS 
        ...
        var defaults = {
            ...
            sDataType: 'json', // // SORTS  Added by AGS 08-07-2014
                ...
                update: function (event, ui) {
                    ...
                    if (properties.sURL != null) {
                        ...
                        var oAjaxRequest = {
                            ...
                            dataType: properties.sDataType, // SORTS Added by AGS 08-07-2014
