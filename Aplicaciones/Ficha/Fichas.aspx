<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Fichas.aspx.vb" Inherits="PlataformaDocente.Fichas" %>
...
<body style="background-color: rgb(232, 232, 232);" onload="fnCommon_nobackbutton();">
    <form id="form1" runat="server">
        <div id="encabezado">
            <table align="center" cellpadding="0" cellspacing="0" style="padding-top: 0.1em; background: #9ed850" border="0">
                <tr>
                            ...
                            <tr>
                                <td style="width: 300px;">
                                    <table align="center">
                                        <tr>
                                            <td>
                                                <img id="imgPortada" alt="cerrar" src="../../Imagenes/Images/btn_portada_OFF.png" onmouseover="this.src='../../Imagenes/Images/btn_portada_ON.png'"
                                                    onmouseout="this.src='../../Imagenes/Images/btn_portada_OFF.png'" onclick="Portada()" style="cursor:pointer"  /></td>
                                        </tr>
                                    </table>
                                </td>
                                <td style="width: 672px;">
                                    <table>
                                        ...
                                        <tr>
                                            <td>
                                                <b><label id="label_evidencia" class="pdEvidencia" runat="server"></label></b>
                                            </td>
                                        </tr>
                                    </table>
                                </td>
                                <td style="width: 300px;">
                                    <table align="center">
                                        <tr>
                                            <td>
                                                <img id="imgCerrar" alt="cerrar" src="../../Imagenes/Images/cerrar_sesion_OFF.png" onmouseover="this.src='../../Imagenes/Images/cerrar_sesion_ON.png'"
                                                    onmouseout="this.src='../../Imagenes/Images/cerrar_sesion_OFF.png'" onclick="CerrarSesion()" style="cursor:pointer"/></td>
                                            <%-- top.document.location='../../Inicio.aspx?cerrar=1'--%>
                                        </tr>
                            ...
                            <tr>
                                <td>
                                    <table id="autoevaluacionf" align="center" cellpadding="0" cellspacing="0" border="0">
                                        <tr>
                                            <td style="height: 54px; width: 6px; background: url('../../Imagenes/images/botonera_izq_f.png') no-repeat"></td>
                                            ...
                                            <td style="width: 6px; background: url('../../Imagenes/images/botonera_der_f.png') no-repeat"></td>
                                            <td style="width: 30px;"></td>
                                        </tr>
                                    </table>
                                </td>

                                <td style="width: 6px; background: url('../../Imagenes/images/botonera_izq_f.png') no-repeat"></td>
                                <td style="background: #f6f6f6">
                                    <table cellpadding="0" cellspacing="0" border="0">
                                        <tr>
                                            <td style="height: 54px; padding: 0px 1px 0px 1px">
                                                <button id="T1" class="botonPF" runat="server" style="width: 8em; height: 2em;">
                                                    Planificación</button></td>
                                            <td style="height: 54px; padding: 0px 1px 0px 1px">
                                                <button id="T2" class="botonPF" runat="server" style="width: 8em; height: 2em;">
                                                    Evaluación
                                                </button>
                                            </td>
                                            <td style="height: 54px; padding: 0px 1px 0px 1px">
                                                <button id="T3" class="botonPF" runat="server" style="width: 8em; height: 2em;">
                                                    Reflexión</button>
                                            </td>
                                        </tr>
                                    </table>
                                </td>
                                <td style="width: 36px; background: url('../../Imagenes/images/botonera_cen_pf_f.png') no-repeat"></td>
                                <td style="background: #f6f6f6">
                                    <table cellpadding="0" cellspacing="0" border="0">
                                        <tr>
                                            <td>
                                                <button id="T4" class="botonPF" runat="server" style="width: 8em; height: 2em;">
                                ...
                                <td style="background: #f6f6f6">
                                    <table cellpadding="0" cellspacing="0" border="0">
                                        <tr>
                                            <td>
                                                <button id="T5" class="botonPF" runat="server" style="width: 8em; height: 2em;">
                                                    Módulo 3</button>
                                            </td>
                                        </tr>
                                    </table>
        ...
        <div id="alert-messageAE" style="background-color: rgb(230, 185, 184);">
            <table style="width: 100%" cellpadding="0" cellspacing="0" border="0">
                <tr>
                    <td align="center" class="pdTituloBv">Estimado/a docente, el período de<br /> elaboración de Autoevaluacion<br /> ha finalizado.</td>
                </tr>
                <tr>
                    <td class="pdTextoBv">
                        <p style="text-align: justify">Usted puede descargar y guardar un respaldo de su Autoevaluación desde "Mi avance en Autoevaluación", opción "Descargar mi avance".</p>
                    </td>
                </tr>
            </table>
        </div>
