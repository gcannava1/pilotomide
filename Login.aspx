<%@ Page Language="VB" AutoEventWireup="false" Inherits="PlataformaDocente.Login" CodeBehind="Login.aspx.vb" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        $.fn.ready(function () {
            $('#Tabla_Mostrar1').css('display', 'none');
            $("#down_image").css('display', '');
            $('#tr_browser').hide()
    ...
    <form id="frmLogin" runat="server">
                                    ...
                                    <table border="0" cellpadding="3" style="width: 300px;">
                                        <tr class="ui-widget">
                                            <td style="height: 50px;">
                                                <a id="btnOlvido" href="#">Recuperar contraseña</a>
                                            </td>
                                            <td align="right"><a id="btnAyuda" href="#" onclick="">¿Cuál es mi usuario?</a></td>
                                        </tr>
                                    </table>
                                </td>
                            </tr>
                                ...
                                <td>
                                    <table align="center" border="0" cellpadding="3">
                                        ...
                                        <tr>
                                            ...
                                            <td style="width: 50px">
                                                <img src="imagenes/images/br_chrome.png" width="40" alt="" /></td>
                                            <td>Google Chrome</td>
                                        </tr>
                                        <tr>
                                            <td></td>
                                            <td>
                                                <img src="imagenes/images/br_firefox.png" width="40" alt="" /></td>
                                            <td>Firefox</td>
                                        </tr>
                                        <tr>
                                            <td></td>
                                            <td>
                                                <img src="imagenes/images/br_ie.png" width="40" alt="" /></td>
                                            <td>Internet Explorer 10 en adelante</td>
                                        </tr>
                                        <tr>
                                            <td></td>
                                            <td>
                                                <img src="imagenes/images/br_edge.png" width="40" alt="" /></td>
                                            <td>Edge</td>
                                        </tr>
                                    </table>
        ...
        <div id="info-message2" style="background: #ffffff;">
            <p id="info-message-content2">
                <img alt="" src="Imagenes/Images/ayuda_ingreso.jpg" />
            </p>
        ...
        <div id="info-message3">
            <table align="center" border="0">
                <tr>
                    <td colspan="2">
                        <asp:Label ID="Label2" runat="server"><b>Ingrese su RUT y si está de acuerdo con la "Cláusula de responsabilidad", presione el botón "Confirmar".</b></asp:Label>
                    </td>
                </tr>
                <tr>
                    <td>&nbsp</td>
                ...
                <tr>
                    <td align="center" colspan="2">
                        <asp:Label ID="Label1" runat="server" Text="Ingresar RUT: "></asp:Label>
                    ...
                    <td>
                        <table align="center" border="0">
                            <tr id="Mostrar_Tabla1" class="Mostrar_Tabla">
                                <td align="center">
                                    <label style="color: blue;"><u>Cláusula de responsabilidad</u></label>
                                    <img alt="" src="Imagenes/unedit.png" id="down_image" />
                                </td>
                            </tr>
                            <tr id="Tabla_Mostrar1">
                                <td>
                                    <table align="center" border="0">
                                        <tr>
                                            <td colspan="2">
                                                <p style="text-align: justify">
                                                    <b><small>En el evento de que el usuario, o la persona a quien él le encomiende la responsabilidad y
                                                    actúe a su nombre, acceda a la Plataforma Docentemás mediante el uso de una contraseña secreta,
                                                    la responsabilidad derivada de falta de cuidado, de la indebida reserva, del mal uso o del uso
                                                    por terceros autorizados o no, mediate su mandato, ocasionándose o no perjuicios directos o indirectos
                                                    o de cualquier especie, es exclusivamente del titular de dicha contraseña.
                                                    </small></b>
                                                </p>
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            <td align="left">
                                                <input type="button" id="btnVolver" runat="server" value="Volver" />
                                            </td>
                                            <td align="right">
                                                <input type="button" id="btnConfirmar" runat="server" value="Confirmar" />
                                            </td>
                                        </tr>
                                    </table>
                                </td>
