<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="DocentePrimeraVez.aspx.vb" Inherits="PlataformaDocente.DocentePrimeraVez" %>
...
<head id="head" runat="server">
            ...
            $('.btnGrabar')
                ...
                .click(function (event) {
                    ...
                    if (validar_evaluacion() == true) {
                        ...
                        if ($('#password_reingresado').val() == '' && $('#password').val() != '') {
                            ...
                            if ($('#password').val() != $('#password_reingresado').val() && $('#password').val() != '') {
                                $('#password_reingresado').focus();
                                $("#alert-message").dialog("option", "title", "Error");
                        ...
                        methodURL = "DocentePrimeraVez.aspx/SaveData";
    ...
    function mostrar_msjeImportante() {
        var methodURL = baseUrl + "DocentePrimeraVez.aspx/MsjeImportante";
        $.ajax(
            {
                type: "POST",
                contentType: "application/json; charset=utf-8",
                        ...
                        <tr>
                            <td align="right">
                                <img id="imgPortada" runat="server" alt="cerrar" src="Imagenes/Images/btn_portada_OFF.png" onmouseover="this.src='Imagenes/Images/btn_portada_ON.png'"
                                    onmouseout="this.src='Imagenes/Images/btn_portada_OFF.png'" onclick="Portada()" class="blockArrastre" style="cursor:pointer" /></td>
                            <td colspan="2"></td>
                            <td></td>
                            <td colspan="2">
                                <table align="center">
                                    <tr>
                                        <td>
                                            <img alt="cerrar" src="Imagenes/Images/cerrar_sesion_OFF.png" onmouseover="this.src='Imagenes/Images/cerrar_sesion_ON.png'"
                                                onmouseout="this.src='Imagenes/Images/cerrar_sesion_OFF.png'" onclick="CerrarSesion()" class="blockArrastre" style="cursor:pointer"/>
                                        </td>
                                    </tr>
                                </table>
                            </td>
